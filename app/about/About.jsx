...
const About = () => {
  return (
    <div className='px-4 sm:px-20 max-w-[1280px] mx-auto'>
      ...
      <section className='flex flex-col lg:flex-row-reverse gap-14 lg:gap-[4.75rem] mt-8 lg:mt-20'>
        <Images />
        <section className='flex-1 flex flex-col gap-6 sm:gap-10 sm:w-[42.5rem]'>
